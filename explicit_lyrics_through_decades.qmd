...
```{python}
number = get_table(2020)
print(number)
```

```{python}
# filter = lyrics('https://genius.com/Ice-spice-munch-feelin-u-lyrics')
# print(filter)


# # print(song_bad_word(year_artist_song))

# start_year = 2021
# end_year = 2022
# word_counter_total(start_year, end_year)
```
