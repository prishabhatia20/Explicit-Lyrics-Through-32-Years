...
```{python}
all_bad_words = []
field_names = ['Fuck', 'Shit', 'Ass', 'Bitch', 'Cunt', 'Dick', 'Sex', 'Slut', 'Pussy', 'Crap', 'Hell', 'Cock', 'Penis', 'Bussy', 'Motherfucker', 'Hoe', 'Whore']
...
```{python}
word_counter_total(2020, 2021)
print(word_counter_total)
```
